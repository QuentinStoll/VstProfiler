...
foreach(idx RANGE ${PRESET_MAX})
    ...
    if(name STREQUAL PRESET_NAME)
        ...
        string(JSON ENABLE_LOG ERROR_VARIABLE err GET "${PRESETS_JSON}" presets ${idx} features logging)
        string(JSON ENABLE_PERF_LOG ERROR_VARIABLE err GET "${PRESETS_JSON}" presets ${idx} features perfLogging)
